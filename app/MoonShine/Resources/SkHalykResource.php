...
/**
 * @extends ModelResource<SkHalyk>
 */
class SkHalykResource extends ModelResource
{
    protected string $model = Confirmation::class;

    protected string $title = 'SkHalyk проверка';
    ...
    {
        return $builder->where('type', 'skhalyk');
    }
    ...
    protected function formFields(): iterable
    {
        return [
            Box::make([
                ID::make(),
                Hidden::make('type')->default('skhalyk'),
